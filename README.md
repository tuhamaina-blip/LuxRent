...
This repository contains the core structure and design for LuxRent. The aesthetic is tailored for the enterprise real market, utilizes hight-contrast visual language to highlight premium listings.
...
```bash
   git clone https://github.com/tuhamaina-blip/luxrent.git
   cd luxrent
```
